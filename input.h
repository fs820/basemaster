...
bool GetKeyboardPress(int nkey);//キー押下処理
bool GetKeyboardTrigger(int nkey);//キー入力処理
bool GetKeyboardRelease(int nkey);//キー離し処理
bool GetKeyboardRepeat(int nkey);//キー長押し処理
